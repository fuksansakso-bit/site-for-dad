...
| `TBD-INFRA-006` | Каков WhatsApp integration mode? | Phase 1E handoff | High | `SAFE_DEFAULT_SELECTED_FOR_PHASE_1E` | Business API не подтверждён | Fixed-recipient `wa.me`/copy-to-clipboard с confirmed number; не заявлять sent/delivery/read | До выбора Business API/automation | Владелец / Architecture |
