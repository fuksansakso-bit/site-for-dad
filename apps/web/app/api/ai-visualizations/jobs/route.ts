  ...
  try {
    ...
    const { data: job, error } = await client
      ...
      .insert({
        ...
        ip_hash: ipHash,
        article_snapshot: material.article,
        availability_snapshot: material.availability,
        category_snapshot: material.categoryName,
        color_snapshot: material.color,
        material_id: material.id,
        material_image_path_snapshot: _storagePath,
        material_name_snapshot: material.name,
        material_slug_snapshot: material.slug,
        model_name: config.modelName,
        output_size: config.outputSize,
        product_metadata: parsed.data.productMetadata ?? {},
        product_family: material.family,
